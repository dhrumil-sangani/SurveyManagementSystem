...
const SurveyForm = () => {
  ...
  const dataSource = [
    { key: "1", name: "Survey 1", startDate: "2023-08-01", endDate: "2023-08-15" },
    { key: "2", name: "Survey 2", startDate: "2023-09-01", endDate: "2023-09-15" },
    { key: "3", name: "Survey 3", startDate: "2023-10-01", endDate: "2023-10-15" },
  ];
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "delete",
      width: 70,
      render: () => <DeleteOutlined style={{ color: "#ff4d4f", cursor: "pointer" }} />,
    },
    {
      title: "Assign",
      dataIndex: "assign",
